...
# Initialize a set to store user names
names = set()

# Create the main user interface class
class MainUI(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Load existing user names from a file
        with open("F:\\BUET\\4-1\\Thesis\\Face Detector\\FaceDetector\\Code\\namelist.txt", "r") as f:
            x = f.read()
            z = x.rstrip().split(" ")
            for i in z:
                names.add(i)
    ...
    def on_closing(self):
        # Save the user names to a file before quitting
...
class PageTwo(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.dropdown.grid(row=0, column=1, ipadx=8,
        padx=10, pady=10)
...
# Create an instance of the MainUI class
app = MainUI()

# Set the application icon
# app.iconphoto(False, tk.PhotoImage(file='F:\\BUET\\4-1\\Thesis\\Face Detector\\FaceDetector\\Code\\icon.ico'))
